    ...
    class EnterIntoDatabase extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                String enterRegistration = String.format("INSERT INTO `reservations` (`parkingId`, `startDateTime`, `endDateTime`, `userId`, `invoiceId`, `rowId`, `columnId`) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s');", parkingId, selectedStartTime, selectedEndTime, userId, paymentId, Integer.toString(finalI), Integer.toString(finalJ) );
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                while(resultSetGetVal.next()) {
                    ...
                    userName = resultSetGetVal.getString("name");
...
//                });
            ...
            checkout.setKeyID("rzp_test_wunDn5b7aKFuha");
